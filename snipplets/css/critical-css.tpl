...
{# /* =============================================================================
   AJUSTE COMPLETO DO CARROSSEL DE PROMOÇÕES
   
   INSTRUÇÕES DE IMPLEMENTAÇÃO:
   1. Adicione TODO este CSS no final do arquivo: /snipplets/css/critical-css.tpl
   2. Adicione o JavaScript (fornecido separadamente) no final de: /static/js/store-v2.js.tpl
   3. Salve os arquivos e force refresh da página (Ctrl+Shift+R)
   
   ============================================================================= */ #}

{# /* =============================================================================
   CAMADA 1: CORREÇÃO BASE DO CARROSSEL
   ============================================================================= */ #}

{# /* Seção de promoções - anula alterações de grid */ #}
...
{# /* Wrapper dos slides - CRÍTICO PARA FUNCIONAMENTO */ #}
...
{# /* Slides individuais - CONFIGURAÇÃO CHAVE */ #}
...
{# /* Configuração específica de largura por breakpoint */ #}
...
{# /* Container dos produtos no carrossel */ #}
...
{# /* Hover nos produtos do carrossel */ #}
...
{# /* Remove TODAS as regras de grid que podem interferir */ #}
[data-store="home-products-sale"] .js-masonry-grid,
...
{# /* Remove configurações de item que interferem */ #}
...
{# /* Garante que o Swiper funcione independentemente */ #}
...
{# /* =============================================================================
   CAMADA 2: FORCE OVERRIDE (MÁXIMA PRIORIDADE)
   ============================================================================= */ #}

{# /* FORÇA COMPORTAMENTO CORRETO DO SWIPER - PRIORIDADE MÁXIMA */ #}

/* Força o container principal */
.js-swiper-sale-products[class*="swiper"] {
  display: block !important;
  width: 100% !important;
  overflow: hidden !important;
  position: relative !important;
...
/* Força wrapper correto */
.js-swiper-sale-products .swiper-wrapper[class*="swiper"] {
  display: flex !important;
  width: auto !important;
  height: auto !important;
  flex-direction: row !important;
...
/* FORÇA LARGURA DOS SLIDES - CHAVE PARA FUNCIONAR */
.js-swiper-sale-products .swiper-slide[class*="swiper"] {
  display: block !important;
  position: relative !important;
  flex-shrink: 0 !important;
  width: auto !important;
...
@media (max-width: 767px) {
  ...
  .js-swiper-sale-products .swiper-slide[class*="swiper"]:last-child {
    margin-right: 0 !important;
  }
}

/* DESKTOP: FORÇA 4 SLIDES POR VEZ */
@media (min-width: 768px) {
  .js-swiper-sale-products .swiper-slide[class*="swiper"] {
  ...
  .js-swiper-sale-products .swiper-slide[class*="swiper"]:nth-child(4n) {
    margin-right: 0 !important;
  }
}

/* Remove todas as interferências de grid para esta seção */
[data-store="home-products-sale"] * {
  column-count: auto !important;
  column-gap: 0 !important;
...
/* Força comportamento específico para produtos */
.js-swiper-sale-products .item-container[class*="item"],
.js-swiper-sale-products .js-masonry-grid-item[class*="item"] {
  width: 100% !important;
  max-width: 100% !important;
...
/* Produtos dentro dos slides */
.js-swiper-sale-products .item[class*="item"] {
  display: flex !important;
  flex-direction: column !important;
  ...
  border-radius: 15px !important;
  overflow: hidden !important;
  box-shadow: 0 4px 8px rgba(50, 50, 50, 0.15) !important;
}

/* IMPORTANTE: Remove qualquer transform que possa interferir */
.js-swiper-sale-products .swiper-slide:not(.swiper-slide-active):not(.swiper-slide-next):not(.swiper-slide-prev) {
  transform: none !important;
}

/* Força estilos de imagem corretos */
.js-swiper-sale-products .item-image-container[class*="item"] {
  height: 200px !important;
  max-height: 200px !important;
  min-height: 200px !important;
  overflow: hidden !important;
...
/* Navegação forçada */
.js-swiper-sale-products-prev[class*="swiper"],
.js-swiper-sale-products-next[class*="swiper"] {
  position: absolute !important;
  top: 50% !important;
  transform: translateY(-50%) !important;
...
/* Paginação forçada */
.js-swiper-sale-products-pagination[class*="swiper"] {
  position: relative !important;
...
/* OVERRIDE CRÍTICO: Remove qualquer configuração de Masonry desta seção */
[data-store="home-products-sale"] .js-masonry-grid[class*="masonry"],
[data-store="home-products-sale"] .grid[class*="grid"],
[data-store="home-products-sale"] .product-grid[class*="grid"] {
  display: block !important;
  column-count: auto !important;
